...
export const COMMANDS: CommandItem[] = [
  ...
  { id: 'business-strategy', label: 'Business Strategy', to: '/business/strategy', icon: 'Target', section: 'Business', keywords: ['opportunity', 'framework', 'market', 'tam', 'moat', '7 powers', 'jtbd', 'radar'] },
