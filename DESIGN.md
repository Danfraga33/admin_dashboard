...
## Overview
Dark-first dashboard. Warm gold/amber accent on deep navy-charcoal backgrounds.
Sharp, data-dense, editorial. Think founder's cockpit — not a consumer app.

## Source
 Use the dark mode values as the default — this dashboard is always dark.

## Key Design Decisions
- **Always dark mode** — ignore the :root (light) values entirely
- **Primary accent** — oklch(0.85 0.08 55) — warm gold/amber
- **Background** — oklch(0.12 0.005 250) — deep navy-charcoal
- **Cards** — oklch(0.16 0.005 250) — slightly lighter than background
- **Typography** — Source Serif 4 for body, Playfair Display for headings, Geist Mono for data/numbers
- **Radius** — 0.625rem — subtle rounding, not bubbly
- **Spacing** — generous and spacious. Breathable layouts, not cramped. 
  Data-dense but never cluttered. Wide padding, clear visual separation between sections.
